 ...
 * La struttura e' definita nel .c (information hiding)
 */
...
/*
 * dequeue: rimuove e restituisce il primo studente in attesa
...
/*
 * visualizzaCoda: stampa a schermo tutti gli studenti
 * in attesa per una fascia oraria
 */
...
/*
 * dimensioneCoda: restituisce il numero di studenti in attesa
 * per una fascia oraria*/ 
